...
export default function TripsPage() {
            ...
            <table className="table table-zebra w-full">
              ...
              <tbody>
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan={6} className="text-center text-red-500">Failed to load trips</td>
                  </tr>
                ) : trips.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="text-center text-gray-400">No trips found</td>
                  </tr>
                ) : (
                  trips.map((trip) => (
                    <tr key={trip.id}>
  ...
  >
    {trip.Status === "ONTHEWAY" ? "On the Way" : "Completed"}
  </span>
</td>
